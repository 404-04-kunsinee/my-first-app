...
st.markdown("#  :red[🏋️ คํานวณค่าดัชนีมวลกาย BMI]")
st.write("กรอกข้อมูลนํ้าหนักเเละส่วนสูงของคุณ เพื่่อเช็กสุขภาพเบื้องต้น")

#ส่วนที่ 2 สร้างช่องรับค่านํ้าหนัก เเละ ส่วนสูง
...
#ส่วนที่ 3 สร้างปุ่มกดคํานวณ
  if st.button("คํานวณค่า BMI 🎯"):
    # แปลงส่วนสูงจาก cm เป็น เมตร เเล้วคํานวณ BMI
...
#ส่วนที่ 4 เเปลผลค่า BMI ตามเกณฑ์
   if bmi < 18.5:
       ...
       st.error("🚨 คุณอยู่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพเเละออกกําลังกาย")
